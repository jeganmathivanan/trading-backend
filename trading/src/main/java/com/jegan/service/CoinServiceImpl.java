...
import com.jegan.repository.CoinRepository;
   ...
   private ObjectMapper objectMapper;
    ...
    public String getCoinsDEtails(String coinId) throws Exception {
        ...
        try{
            ...
            coin.setMarketCapChange24h(marketData.get("price_cap_change_24h").asLong());
    ...
    public Coin findById(String coinId) throws Exception {
        ...
        if(optionalCoin.isEmpty())throw new Exception();
